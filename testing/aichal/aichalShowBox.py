...
if __name__ == '__main__':
    ...
    if args.type == 'cmu':
        pred = 'pred_cmu_val_0.8.json'
    elif args.type == 'aichal':
        pred = 'pred_cmu_aichal_v2_40_val_0.6.json'
    elif args.type == 'fuse':
        pred = 'pred_fuse_average_aichal_val_40_0.8_0.6.json'
    elif args.type == 'fuseMPI':
        pred = 'pred_fuse_averageBody_mpi_aichal_val_40_0.6_0.6_0.6.json'
    else:
        print('not in option')
        exit(0)
