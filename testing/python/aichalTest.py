...
if __name__ == '__main__':
    test = np.loadtxt('data/aichal/test.txt', dtype=str)
    predict = predict()
    ...
    for i, imname in enumerate(test):
        _t.tic()
        imname = os.path.join('data/aichal/test', imname)
    ...
    print(len(results))
    with open('aichalTest4Scale.pkl', 'wb') as f:
