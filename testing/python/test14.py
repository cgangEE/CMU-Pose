...
#    imnames = ['0.jpg', '0_0.jpg', '0_1.jpg', '0_2.jpg', '111_0.jpg', '111_1.jpg']

    val = np.loadtxt('data/aichalCrop/val.txt', dtype=str)

    predict = predict()

    for i, imname in enumerate(val):
        imname = os.path.join('data', 'aichalCrop', 'val', imname)
        predict.predict(imname, i)
